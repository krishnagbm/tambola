    ...
    return LayoutBuilder(
      builder: (ctx, constraints) {
        ...
        final card1 = _buildSplitCard(
          ...
          title: 'Hosting a Party or Corporate Event?',
          description: 'Host from 10 to 250+ guests in 30 seconds. Seamless for family parties & corporate events with automated prize validation.',
